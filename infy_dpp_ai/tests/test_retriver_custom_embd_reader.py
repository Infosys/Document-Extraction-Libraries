...
PROCESSOR_INPUT_CONFIG_PATH = "/data/config/inference_batch_custom_embd_input_config_data.json"
...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['inference_batch_custom_embd_input_config_data.json', f"{SAMPLE_ROOT_PATH}/data/config",
        ...
        ['*.*', f"{SAMPLE_ROOT_PATH}/mistral-embd/vectordb",
