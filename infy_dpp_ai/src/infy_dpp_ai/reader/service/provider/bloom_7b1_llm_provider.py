...
class Bloom7b1LlmProviderConfigData(BaseLlmProviderConfigData):
    """Domain class"""
...
class Bloom7b1LlmRequestData(BaseLlmRequestData):
    """Domain class"""


class Bloom7b1LlmResponseData(BaseLlmResponseData):
    """Domain class"""


class Bloom7b1LlmProvider(ILlmProvider):
    """Open AI LLM provider"""

    def __init__(self, config_data: Bloom7b1LlmProviderConfigData) -> None:
    ...
    def get_llm_response(self, llm_request_data: Bloom7b1LlmRequestData) -> Bloom7b1LlmResponseData:
        try:
            llm_response_data = Bloom7b1LlmResponseData()  
