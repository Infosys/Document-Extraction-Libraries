...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['pipeline_yolox_input_config_data.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_dpp_extractor():
    ...
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_yolox_input_config_data.json'
    ...
    assert response_data_list[0].context_data['content_extractor'] is not None
