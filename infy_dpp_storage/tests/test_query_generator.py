...
PROCESSOR_INPUT_CONFIG_PATH =f"/data/config/dpp_pipeline_generator_input_config.json"
...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['dpp_pipeline_generator_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_query_generator():
    """
        Test case for query_gengeration
    """
    ...
    for response_data in response_data_list:
        ...
        assert response_data.context_data.get('db_query_generator').get('output')  is not None
