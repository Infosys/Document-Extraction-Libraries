...
PROCESSOR_INPUT_CONFIG_PATH =f"/data/config/dpp_pipeline_executor_input_config.json"
...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['dpp_pipeline_executor_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
            f"{STORAGE_ROOT_PATH}/data/config"],
        ['document_data.json', f"{SAMPLE_ROOT_PATH}/work/D-bf978e1a-75a1-42f3-9d94-a2f6cbad2d97_executor/sample_data.txt_files",
