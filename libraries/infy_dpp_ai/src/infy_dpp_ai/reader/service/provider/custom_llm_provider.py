...
class CustomLlmProvider(ILlmProvider):
    ...
    def __init__(self, config_data: CustomLlmProviderConfigData, json_payload_dict: dict, custom_llm_name: str, file_sys_handler, logger, app_config) -> None:
    ...
    def get_llm_response_batch(self, llm_request_data: CustomLlmRequestData):
        pass
