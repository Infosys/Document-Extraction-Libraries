...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['semantic_search_input_config_data.json', f"{SAMPLE_ROOT_PATH}/data/config",
        ...
        ['qna_data.xlsx', f"{SAMPLE_ROOT_PATH}/data/input",
    ...
    logging_config_data = infy_fs_utils.data.LoggingConfigData(
        **{
            ...
            "log_file_data": {
                ...
                "log_file_name_prefix": "infy_dpp_ai",
...
def test_semantic_search():
    """
        Test case for semantic search
    """
    # Ensure the index-id is properly configured in the input config file
    PROCESSOR_INPUT_CONFIG_PATH = "/data/config/semantic_search_input_config_data.json"
    ...
    assert response_data_list[0].context_data['semantic_search'] is not None
