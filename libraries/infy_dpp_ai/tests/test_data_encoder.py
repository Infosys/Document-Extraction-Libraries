...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['mde_prompt.txt', f"{SAMPLE_ROOT_PATH}/config/prompt_templates/mde_prompts",
            f"{STORAGE_ROOT_PATH}/data/config/prompt_templates/mde_prompts"],
        ['mde_prompt_decider.txt', f"{SAMPLE_ROOT_PATH}/config/prompt_templates/mde_prompts",
            f"{STORAGE_ROOT_PATH}/data/config/prompt_templates/mde_prompts"],
        ['mde_prompt_optimized.txt', f"{SAMPLE_ROOT_PATH}/config/prompt_templates/mde_prompts",
            f"{STORAGE_ROOT_PATH}/data/config/prompt_templates/mde_prompts"],
    ]
