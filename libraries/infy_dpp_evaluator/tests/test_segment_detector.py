...
def pre_test(create_root_folders, copy_files_to_root_folder, copy_folders_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['pipeline_segment_report_generator_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_dpp_segment_detector():
    """
        Test case for dpp_segment_detector
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_segment_report_generator_input_config.json'
