...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['questions_version2.xlsx', f"{SAMPLE_ROOT_PATH}/input",
            f"{STORAGE_ROOT_PATH}/data/input"],
        ['rag_metrics.json', f"{SAMPLE_ROOT_PATH}/input",
         f"{STORAGE_ROOT_PATH}/data/input"],
        ['pipeline_report_generator_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_report_generation_1():
    """
        Test case for report generation
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_report_generator_input_config.json'
