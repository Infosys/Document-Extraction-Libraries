...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['rag_result.json', f"{SAMPLE_ROOT_PATH}/input",
            f"{STORAGE_ROOT_PATH}/data/input"],
        ['pipeline_evaluation_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_evaluation_1():
    ...
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_evaluation_input_config.json'
