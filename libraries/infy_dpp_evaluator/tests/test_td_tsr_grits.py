"""Test module for TD and TSR flow"""
# ===============================================================================================================#
...
def pre_test(create_root_folders, copy_files_to_root_folder, copy_folders_to_root_folder):
    ...
    SAMPLE_EXTERNAL_ROOT_PATH = "./data/sample/trial"
    FILES_TO_COPY = [
        ['pipeline_segment_td_tsr_eval_report_grits_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_td_tsr_eval_report_trial():
    """
        Test case for Segment recognition and evaluation with TD and TSR enabled
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_segment_td_tsr_eval_report_grits_input_config.json'
    ...
    assert response_data_list[0].context_data['segment_reporter'] is not None
