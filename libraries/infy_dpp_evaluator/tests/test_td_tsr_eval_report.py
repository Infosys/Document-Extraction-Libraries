...
def pre_test(create_root_folders, copy_files_to_root_folder, copy_folders_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['pipeline_segment_td_tsr_eval_report_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_td_tsr_eval_report():
    """
        Test case for Segment recognition and evaluation with TD and TSR enabled
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_segment_td_tsr_eval_report_input_config.json'
