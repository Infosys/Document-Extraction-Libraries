...
def pre_test(create_root_folders, copy_files_to_root_folder, copy_folders_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['pipeline_input_config_data_v2.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_request_creator_1():
    """
        Test case for request_creator
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_input_config_data_v2.json'
