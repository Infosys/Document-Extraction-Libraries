...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['dpp_event_handler_input_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_rag_index_id_handler():
    """
        Test case for rag_index_id_handler.
        Enable and setup events in config prior to running this test
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/dpp_event_handler_input_config.json'
