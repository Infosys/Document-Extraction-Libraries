...
STORAGE_ROOT_PATH = f"C:/temp/unittest/infy_dpp_core/{__name__}/STORAGE"
CONTAINER_ROOT_PATH = f"C:/temp/unittest/infy_dpp_core/{__name__}/CONTAINER"
...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['pipeline_content_evaluator_input_config_data.json', f"{SAMPLE_ROOT_PATH}/config",
            f"{STORAGE_ROOT_PATH}/data/config"],
        ['qna_data.xlsx', f"{SAMPLE_ROOT_PATH}/input",
...
def test_request_creator_1():
    """
        Test case for RequestCreatorV2 for content_evaluation mode
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_content_evaluator_input_config_data.json'
