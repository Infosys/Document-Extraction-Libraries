...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['dpp_batch_report_config.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_batch_report_generation():
    """
        Test case for batch_report_generation.
        Enable and setup events in config prior to running this test
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/dpp_batch_report_config.json'
