...
class WithoutSubContextResParserProvider(ILLMResponseParserProvider):
    """Class for without subcontext response parser provider"""
    ...
    def parse_llm_response(self, llm_response_txt, input_que_type: dict, context: str) -> QnaResponseData:
        ...
        qna_response_data = QnaResponseData(qna_data_list=qna_list)
