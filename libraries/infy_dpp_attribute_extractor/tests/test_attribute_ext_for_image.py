...
STORAGE_ROOT_PATH = f"C:/temp/unittest/infy_dpp_attribute_extractor/{__name__}/STORAGE"
CONTAINER_ROOT_PATH = f"C:/temp/unittest/infy_dpp_attribute_extractor/{__name__}/CONTAINER"
...
def test_attribute_extraction():
    """
        Test case for dpp_attribute_extractor
    """
    ...
    raw_attributes = response_data_list[0].context_data['rd_based_attribute_extractor']['raw_attributes']
    assert {
        raw_attributes[0]['name']: raw_attributes[0]['values'][0]['text_obj_list']['text']
    } == {'Invoice No:': 'SDCKL00562710'}
    assert {
        raw_attributes[1]['name']: raw_attributes[1]['values'][0]['text_obj_list']['text']
    } == {'Account No': ': 90394384.'}
