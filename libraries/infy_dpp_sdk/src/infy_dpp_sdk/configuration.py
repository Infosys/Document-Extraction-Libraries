...
from .common._internal.data_type_util import DataTypeUtil
from .common._internal.singleton import Singleton
...
class ClientConfigManager(metaclass=Singleton):
    ...
    def load(self, client_config_data: ClientConfigData):
        """
        Load provided ClientConfigData.

        Args:
            client_config_data (ClientConfigData): The client configuration data to load.
        """
    ...
    def get(self):
        """
        Return configured ClientConfigData.

        Returns:
            ClientConfigData: The loaded client configuration data.
        """
