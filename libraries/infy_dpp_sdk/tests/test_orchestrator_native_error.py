...
INPUT_CONFIG_FILE_PATH = '/data/config/dpp_pipeline4_input_config.json'
...
def test_pipeline_1():
    ...
    EXPECTED_MESSAGE = "UNHANDLED EXCEPTION => This is a simulated error from ContentExtractorErrorV1."
