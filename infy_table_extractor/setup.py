...
if __name__ == '__main__':
    ...
    METADATA = dict(
        name="infy_table_extractor",
        version="0.0.11",
        license="Apache License Version 2.0",
        author="Infosys Limited",
        author_email="",
        description="To extract field values from both bordered/ borderless table in an image",
        long_description="",
        long_description_content_type="text/markdown",
        url="",
        package_dir={'infy_table_extractor': 'src/infy_table_extractor',
                     'infy_table_extractor/interface': 'src/infy_table_extractor/interface',
                     'infy_table_extractor/bordered_table_extractor': 'src/infy_table_extractor/bordered_table_extractor',
                     'infy_table_extractor/bordered_table_extractor/internal': 'src/infy_bordered_table_extractor/bordered_table_extractor/internal',
                     'infy_table_extractor/bordered_table_extractor/providers': 'src/infy_bordered_table_extractor/bordered_table_extractor/providers',
                     'infy_table_extractor/bordered_table_extractor/interface': 'src/infy_table_extractor/bordered_table_extractor/interface',
                     'infy_table_extractor/borderless_table_extractor': 'src/infy_table_extractor/borderless_table_extractor',
                     'infy_table_extractor/borderless_table_extractor/internal': 'src/infy_bordered_table_extractor/borderless_table_extractor/internal',
                     'infy_table_extractor/borderless_table_extractor/providers': 'src/infy_bordered_table_extractor/borderless_table_extractor/providers',
                     'infy_table_extractor/borderless_table_extractor/interface': 'src/infy_table_extractor/borderless_table_extractor/interface'},
