...
if __name__ == '__main__':
    ...
    METADATA = dict(
        name="infy_common_utils",
        version="0.0.9",
        license="Apache License Version 2.0",
        author="Infosys Limited",
        author_email="",
        description="Infy Python common util to provide commonly used horizontal APIs.",
        long_description="",
        long_description_content_type="text/markdown",
        url="",
        package_dir={'infy_common_utils': 'src/infy_common_utils',
                     'infy_common_utils/internal': 'src/infy_common_utils/internal'},
