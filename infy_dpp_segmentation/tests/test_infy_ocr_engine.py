...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ['1.jpg', f"{SAMPLE_ROOT_PATH}/input",
            f"{STORAGE_ROOT_PATH}/data/input"],
        ['pipeline_input_config_data.json', f"{SAMPLE_ROOT_PATH}/config",
            f"{STORAGE_ROOT_PATH}/data/config"],
        ['processor_response_data.json', f"{SAMPLE_ROOT_PATH}/work/D-42db2736-81fb-4a97-adec-c097027708ea/1.jpg_files",
            f"{STORAGE_ROOT_PATH}/data/work/D-42db2736-81fb-4a97-adec-c097027708ea/1.jpg_files"],
        ['1.jpg', f"{SAMPLE_ROOT_PATH}/work/D-42db2736-81fb-4a97-adec-c097027708ea",
            f"{STORAGE_ROOT_PATH}/data/work/D-42db2736-81fb-4a97-adec-c097027708ea"]
    ]
    ...
    logging_config_data = infy_fs_utils.data.LoggingConfigData(
        **{
            ...
            "log_file_data": {
                ...
                "log_file_name_prefix": "infy_dpp_segmentation",
...
def test_segment_generator():
    """
        Test case for segmentation generator
    """
    
    document_data_json = infy_dpp_segmentation.common.FileUtil.load_json(
        f"{STORAGE_ROOT_PATH}/data/work/D-42db2736-81fb-4a97-adec-c097027708ea/1.jpg_files/processor_response_data.json")
    config_data_json = infy_dpp_segmentation.common.FileUtil.load_json(
        f"{STORAGE_ROOT_PATH}/data/config/pipeline_input_config_data.json")
    
    # --------- Run the pipeline ------------
    segment_generator = infy_dpp_segmentation.segment_generator.SegmentGenerator()  
    ...
    output_file_path=f"{STORAGE_ROOT_PATH}/data/work/D-42db2736-81fb-4a97-adec-c097027708ea/1.jpg_files/processor_response_data.json"
    infy_dpp_segmentation.common.FileUtil.save_to_json(output_file_path,response_data.dict())
