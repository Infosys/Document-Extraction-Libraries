...
def pre_test(create_root_folders, copy_files_to_root_folder):
    ...
    FILES_TO_COPY = [
        ...
        ['pipeline_input_config_data_scanned_pdf.json', f"{SAMPLE_ROOT_PATH}/config",
...
def test_dpp_segmentation_scanned_pdf():
    """
        Test case for dpp_segmentation for scanned pdfs
    """
    PROCESSOR_INPUT_CONFIG_PATH = '/data/config/pipeline_input_config_data_scanned_pdf.json'
