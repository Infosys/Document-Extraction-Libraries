...
def test_seg_gen_with_table():
    ...
    assert len(
        response_data_list[0].context_data['segment_generator']['segment_data']) == 2
    assert response_data_list[0].context_data['segment_consolidator']['segment_data'] is not None
