...
from infy_dpp_segmentation.segment_parser.process.segment_data_parser import SegmentDataParser
import infy_dpp_sdk
...
class SegmentDataProcessor:
    ...
    def parse_segment_data(self, config_file_data, document_data_path_list):
        ...
        segment_generator_obj = SegmentDataParser(processor_response_data)
